...
*}}
<form name="editplage" action="" method="post" onsubmit="return onSubmitFormAjax(this, { onComplete: function() { loadUser({{$plagevac->user_id}}) ; editPlageVac('{{$plagevac->plage_id}}',{{$plagevac->user_id}})} });">
