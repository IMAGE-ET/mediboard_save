...
<!--
	...
	_smarty_console.document.write("<html><title>Mediboard Smarty Debug Console_"+self.name+"<\/title><body bgcolor=#ffffff>");
	_smarty_console.document.write("<table border=0 width=100%>");
	_smarty_console.document.write("<tr bgcolor=#cccccc><th colspan=2>Mediboard Smarty Debug Console<\/th><\/tr>");
