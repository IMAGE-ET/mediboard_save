...
<table class="form">
  ...
  <tr>
    ...
    <td>
      <select tabindex="6" name="chap1" onchange="this.form.submit()" style="width: 200px;">
  ...
  <tr>
    ...
    <td>
      <select tabindex="7" name="chap2" onchange="this.form.submit()"  style="width: 200px;">
  ...
  <tr>
    ...
    <td>
      <select tabindex="8" name="chap3" onchange="this.form.submit()" style="width: 200px;">
  ...
  <tr>
    ...
    <td>
      <select tabindex="9" name="chap4" onchange="this.form.submit()" style="width: 200px;">
