...
if (isset($_FILES["formfile"])) {
  ...
  $serie_a = array(
    'data' => array(),
    'label' => utf8_encode("Logs par heure")
  );
  $labels = array();
  ...
  $options = CFlotrGraph::merge("lines", array(
    'title'    => utf8_encode("Logs par heure"),
  ...
  $serie_b = array(
    'data' => array(),
    'yaxis' => 2,
    'label' => utf8_encode("Nombre d'ips par heure") 
  );
  $labels = array();
  ...
  $serie = array(
    'data' => array(),
    'label' => utf8_encode("Logs par jour")
  );
  $labels = array();
  ...
  $options = CFlotrGraph::merge("bars", array(
    'title'    => utf8_encode("Logs par jour"),
    'xaxis'    => array('ticks' => $labels),
    'yaxis'    => array('tickDecimals' => 0),
    'grid'     => array('verticalLines' => true)
  ));
