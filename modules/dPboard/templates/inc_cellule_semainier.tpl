...
{{else}}
  ...
  {{if $colonne=="plagesConsult"}}
    <a href="?m={{$m}}&amp;tab={{$tab}}&amp;plageconsult_id={{$plageInfos->plageconsult_id}}" title="Voir le contenu de la plage">
    ...
    {{/if}} 
    <a href="?m={{$m}}&amp;tab=edit_planning&amp;consultation_id=0&amp;plageconsult_id={{$plageInfos->plageconsult_id}}" title="Planifier une consultation dans cette plage"> 
