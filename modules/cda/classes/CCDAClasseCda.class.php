...
class CCDAClasseCda extends CCDAClasseBase{
  ...
  function test() {
    ...
    if (get_class($this) === "CCDAPOCD_MT000040_AuthoringDevice"
        || get_class($this) === "CCDAPOCD_MT000040_Criterion"
        || get_class($this) === "CCDAPOCD_MT000040_Device"
        || get_class($this) === "CCDAPOCD_MT000040_ServiceEvent"
    ) {
      return $tabTest;
    }
