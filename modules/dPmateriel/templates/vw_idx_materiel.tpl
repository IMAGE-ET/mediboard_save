      ...
      <table class="form">
        ...
        <tr>
          <td class="button" colspan="2">
            ...
            {{if $materiel->materiel_id}}
              <button class="trash" type="button" onclick="confirmDeletion(this.form,{typeName:'le matériel',objName:'{{$materiel->_view|escape:javascript}}'{ldelim})">Supprimer</button>
            {{/if}}
          </td>
        </tr>        
      </table>
