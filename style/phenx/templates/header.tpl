...
<table style="width: 100%;">
  <tr>
    ...
    <td style="vertical-align: top; width: 1%; padding-right: 0;">
      <div id="banner">
        <a href="http://www.mediboard.org/"><img src="style/{{$uistyle}}/images/pictures/mbLogo.png" alt="Mediboard :: Système de gestion des structures de santé"  /></a>
      </div>
      
      <div id="user">
        <div class="welcome" title="{{tr}}last connection{{/tr}} : {{$app->user_last_login|date_format:"%A %d %B %Y %Hh%M"}}">
          {{tr}}Welcome{{/tr}} {{$app->user_first_name}} {{$app->user_last_name}}<br />
        </div>
