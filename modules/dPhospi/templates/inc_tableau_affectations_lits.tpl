...
<div id="view_affectatons_tableau" style="overflow-x: auto; overflow-y: scroll;">
  <div style="height: 75px; width: 100%">
    <div id="header_vue_tableau" style="position: absolute; z-index: 200; background: #fff;">
      <table class="main layout" style=" height: 40px; position: relative;">
        <tr>
          <td colspan="2">
      ...
      <table class="tbl">
        <tr>
          {{foreach from=$services item=curr_service}}
            <th {{if $curr_service->externe}}class="service_externe"{{/if}} style="width: {{$width_service}}%;">
              {{$curr_service->nom}}
              <br />
