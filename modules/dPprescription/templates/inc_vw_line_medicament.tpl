    ...
    {{/if}}
      ...
      <form name="commentaire-{{$line->_guid}}">
	      {{include file="../../dPprescription/templates/line/inc_vw_form_add_comment.tpl"}}
		      ...
		      <button class="new notext" title="Ajouter une aide à la saisie" type="button" onclick="addHelp('CPrescriptionLineMedicament', this.form._hidden_commentaire, 'commentaire', null, null, null, {{$userSel->_id}});">
		        Nouveau
		      </button>
		      {{/if}}
	    </form>
