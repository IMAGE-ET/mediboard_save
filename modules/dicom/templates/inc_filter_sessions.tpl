      ...
      <form action="?" name="sessionsFilters" method="post" onsubmit="return DicomSession.refreshSessionsList(this);">
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td colspan="2">{{mb_field object=$session field="group_id" canNull=true form="filterExchange" autocomplete="true,1,50,true,true"}}</td>
          </tr>
          <tr>
            <th colspan="2">{{mb_label object=$session field="sender_id"}}</th>
            <td colspan="2">{{mb_field object=$session field="sender_id" canNull=true form="filterExchange" autocomplete="true,1,50,true,true"}}</td>
          </tr>
          {{*<tr>
          ...
          <tr>
            ...
            <td colspan="2">{{mb_field object=$session field="status" emptyLabel="tous"}}</td>
          </tr>
          <tr>
