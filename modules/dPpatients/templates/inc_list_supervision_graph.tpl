<table class="main tbl">
  <tr>
    <th colspan="2" class="title">
      <button class="new notext compact" onclick="SupervisionGraph.editGraph(0)" style="float: right;">
        {{tr}}New{{/tr}}
      </button>
      Graphiques
    </th>
  ...
  <tr>
    <th colspan="2" class="title">
      <button class="new notext compact" onclick="SupervisionGraph.editPack(0)" style="float: right;">
        {{tr}}New{{/tr}}
      </button>
      Packs
    </th>
