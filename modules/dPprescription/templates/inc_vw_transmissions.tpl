	   ...
	   <td colspan="6">
		    <form name="editTrans" action="?" method="post">
		      ...
		      <div style="float: right">
			    ...
			    <button class="new notext" title="Ajouter une aide à la saisie" type="button" onclick="addHelp('CTransmissionMedicale', this.form.text, null, null, null, null, {{$userSel->_id}})">{{tr}}New{{/tr}}</button><br />      
		    </div>
