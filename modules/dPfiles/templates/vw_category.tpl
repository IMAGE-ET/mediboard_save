<table class="main">
  <tr>
    <td class="halfPane">
      <a class="buttonnew" href="index.php?m={{$m}}&amp;tab=vw_category&amp;file_category_id=0">
      ...
      <table class="tbl">
        ...
        <tr>
          <td>
            <a href="index.php?m={{$m}}&amp;tab=vw_category&amp;file_category_id={{$curr_category->file_category_id}}" title="Modifier la catégorie">
              {{$curr_category->file_category_id}}
            </a>
          </td>
          <td class="text">
            <a href="index.php?m={{$m}}&amp;tab=vw_category&amp;file_category_id={{$curr_category->file_category_id}}" title="Modifier le catégorie">
              {{$curr_category->nom}}
            </a>
          </td>
          <td class="text">
    ...
    <td class="halfPane">
      <form name="editCat" action="./index.php?m={{$m}}&amp;tab=vw_category" method="post" onsubmit="return checkForm(this)">
