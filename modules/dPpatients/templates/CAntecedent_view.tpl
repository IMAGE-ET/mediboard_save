<table class="tbl" id="{{$object->_guid}}_tooltip">
  <tr>
    <th>
      {{mb_label object=$object field=type}}
    </th>
    <td>
      {{if $object->type}}
  ...
  <tr>
    <th>
      {{mb_label object=$object field=appareil}}
    </th>
    <td>
      {{if $object->appareil}}
  ...
  <tr>
    <th>
      {{mb_label object=$object field=date}}
    </th>
    <td>
  ...
  <tr>
    <th>
      {{mb_label object=$object->_ref_first_log field=user_id}}
    </th>
    <td>
      {{$object->_ref_first_log->_ref_user->_view}}
    </td>
  </tr>
  <tr>
    <th>
     {{mb_label object=$object->_ref_first_log field=date}}
    </th>
    <td>
      {{mb_value object=$object->_ref_first_log field=date}}
    </td>
  </tr>
  <tr>
    <th>Actions</th>
