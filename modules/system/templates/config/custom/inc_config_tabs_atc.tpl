...
<textarea style="display:none;" name="c[{{$_feature}}]" {{if $is_inherited}} disabled="disabled" {{/if}} class="editable">{{$value}}</textarea>
  <ul class="list_tabs_doc">
  </ul>
  <div style="clear:both;"></div>
  <button type="button" onclick="createLi(null, $$('ul.list_tabs_doc')[0]);" class="add">Nouvel onglet</button>
