...
<script>
  ...
  Main.add(function () {
    InseeFields.initCPVille("edit_do_create_cabinet", "cp", "ville", "tel");
    addUser('prat');
  });
</script>
          ...
          <td>
            <script>
              ColorSelector.init = function(){
                this.sForm  = "edit_do_create_cabinet";
                this.sColor = "color";
      ...
      <div id="prat_{{$num+1}}" style="display: none;">
        <fieldset>
          ...
          <table class="form">
            ...
            <tr>
              <th><img src="style/mediboard/images/buttons/phone.png" alt="tel"/></th>
