...
<div style="overflow: hidden; height: 0.8em; min-width: 5em; background: #FFF;">
  <div style="height: 55%" title="En stock : {{$stock->quantity}}">
...
;"></div>
  ...
  <div style="background: {{$colors.3}}; height: 55%; opacity: .2;" title="Maximum : {{$stock->order_threshold_max}}">
