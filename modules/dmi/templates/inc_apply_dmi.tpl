...
<div style="text-align: center; outline: 2px solid #999; margin: 0.8em; padding: 0.5em;">
  <button style="float: right;" type="button" class="trash"
          onclick="addDMI('{{$lot->_id}}', 1, getTypeValue(this), getQtyValue(this))">
    Déstérilisé
  </button>
  
  <button style="float: left;" type="button" class="submit" 
          onclick="addDMI('{{$lot->_id}}', 0, getTypeValue(this), getQtyValue(this))">
    Poser
  </button>
  ...
  <label style="margin-left: 2em;">
    ...
    {{mb_field class=CPrescriptionLineDMI field=quantity id=dmi_quantity size=2}}
  </label>
</div>