<tr>
  <th class="title text" colspan="3">
    ...
    {{if $app->_ref_user->isAdmin() }}
      <a href="#" onclick="guid_access_medical('{{$object->_guid}}')" style="float:right;" ><img src="images/icons/planning.png" alt="" /></a>
    {{/if}}
  </th>
</tr>
<tr>
...
{{if $object instanceof CSejour}}
  <tr>
    <td class="text" colspan="2">
      {{if "dPplanningOp CSejour use_charge_price_indicator"|conf:"CGroups-$g" != "no"}}
