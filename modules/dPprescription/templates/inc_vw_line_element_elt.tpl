      ...
      <form name="commentaire-{{$line->_guid}}">
	      {{include file="../../dPprescription/templates/line/inc_vw_form_add_comment.tpl"}}
	        {{if $line->_perm_edit}}
		      ...
		      <button class="new notext" title="Ajouter une aide à la saisie" type="button" onclick="addHelp('CPrescriptionLineElement', this.form._hidden_commentaire, 'commentaire', null, null, null, {{$user_id}});">
		        Nouveau
		      </button>
		      {{/if}}
	    </form>
