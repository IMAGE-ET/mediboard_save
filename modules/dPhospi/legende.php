<table class="tbl">
  ...
  <tr>
    <td align="right"><img src="images/icons/X.png" name="sortant ce soir" /></td>
    <td class="text">Ambulatoire sortant ce soir</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/O.png" name="sortant demain" /></td>
    <td class="text">Hospitalisation sortant demain</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/Oo.png" name="sortant aujourd'hui" /></td>
    <td class="text">Hospitalisation sortant aujourd'hui</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/OC.png" name="déplacé demain" /></td>
    <td class="text">Hospitalisation déplacée demain</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/OoC.png" name="déplacé aujourd'hui" /></td>
  ...
  <tr>
    <td align="right" style="background-image:url(images/icons/ray.gif); background-repeat:repeat;"><strong>M. X y</strong></td>
  ...
  <tr>
    <td align="right"><img src="images/icons/double.png" name="chambre double possible" /></td>
    <td class="text">Chambre double possible</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/seul.png" name="chambre simple obligatoire" /></td>
    <td class="text">Chambre simple obligatoire</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/surb.png" name="colision" /></td>
    <td class="text">Colision : deux patients dans un même lit</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/sexe.png" name="conflit de sexe" /></td>
    <td class="text">Un homme et une femme dans la même chambre</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/age.png" name="ecart d'age important" /></td>
    <td class="text">Ecart d'age important : plus de 15 ans d'écart</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/prat.png" name="conflit de praticiens" /></td>
    <td class="text">Conflit de praticiens : deux patients opérés par deux medecins de même spécialité dans la même chambre</td>
  </tr>
  <tr>
    <td align="right"><img src="images/icons/path.png" name="conflit de pathologie" /></td>
