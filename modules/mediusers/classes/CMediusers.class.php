...
class CMediusers extends CMbObject {
  ...
  var $secteur    = null;
  // Champs utilis�s pour l'affichage des ordonnances ALD
  var $cab        = null;
  var $conv       = null;
  var $zisd       = null;
  var $ik         = null;
  ...
  function store() {
    ...
    //$this->load(); // peut poser probleme, � tester
  ...
  function loadMedecins($permType = PERM_READ, $function_id = null, $name = null, $actif = true) {
    return $this->loadListFromType(array("M�decin"), $permType, $function_id, $name, $actif);
  }
  ...
  function loadAnesthesistes($permType = PERM_READ, $function_id = null, $name = null, $actif = true) {
    return $this->loadListFromType(array("Anesth�siste"), $permType, $function_id, $name, $actif);
  }
  ...
  function loadPraticiens($permType = PERM_READ, $function_id = null, $name = null, $secondary = false, $actif = true) {
    return $this->loadListFromType(array("Chirurgien", "Anesth�siste", "M�decin", "Dentiste"), $permType, $function_id, $name, $secondary, $actif);
  }
  ...
  function loadProfessionnelDeSante($permType = PERM_READ, $function_id = null, $name = null, $secondary = false, $actif = true) {
    return $this->loadListFromType(array("Chirurgien", "Anesth�siste", "M�decin", "Infirmi�re", "R��ducateur", "Sage Femme", "Dentiste"), $permType, $function_id, $name, $secondary, $actif);
  }
  ...
  function loadNonProfessionnelDeSante($permType = PERM_READ, $function_id = null, $name = null, $secondary = false, $actif = true) {
    return $this->loadListFromType(array("Chirurgien", "Anesth�siste", "M�decin", "Infirmi�re", "R��ducateur", "Sage Femme", "Dentiste"), $permType, $function_id, $name, $secondary, $actif, true);
  }
  ...
  function loadPraticiensCompta(){
    ...
    $is_secretaire = in_array(CUser::$types[$this->_user_type], array("Secr�taire"));
  ...
  function loadKines($permType = PERM_READ, $function_id = null, $name = null) {
    return $this->loadListFromType(array("R��ducateur"), $permType, $function_id, $name);
  }
  ...
  function isPraticien() {
    return $this->_is_praticien = $this->isFromType(array("M�decin", "Chirurgien", "Anesth�siste", "Dentiste"));
  }
   ...
   */
  function isAnesth() {
    return $this->_is_anesth = $this->isFromType(array("Anesth�siste"));
  }
  ...
  function isInfirmiere() {
    return $this->_is_infirmiere = $this->isFromType(array("Infirmi�re"));
  }
   ...
   */
  function isMedical() {
    return $this->isFromType(array("Administrator", "Chirurgien", "Anesth�siste", "Infirmi�re", "M�decin", "R��ducateur", "Sage Femme", "Dentiste"));
  }
  ...
  function isExecutantPrescription() {
    return $this->isFromType(array("Infirmi�re", "Aide soignant", "R��ducateur"));
  }
   ...
   */
  function isKine() {
    return $this->isFromType(array("R��ducateur"));
  }
  ...
  /**
   * Charge la liste de plages et interventions pour un jour donn�
   ...
   *
   * @param int $group_id Permet de charger l'id externe d'un Mediuser pour un �tablissement donn� si non null
   *
   * @return string
   */
