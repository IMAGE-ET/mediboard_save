...
$plageastreintes = new CPlageAstreinte();
$plagesastreintes = array();
$orderby="user_id";
$plagesastreintes = $plageastreintes->loadList($where, $orderby);
$tabUser_plage = array();
...
$smarty->assign("plagesastreintes",     $plagesastreintes);
...
$smarty->display("vw_planning_astreinte.tpl");
