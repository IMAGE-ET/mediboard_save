      ...
      <form action="?" name="filterEchange" method="get">
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td>{{mb_field object=$echange_soap field="_date_min" form="filterEchange" register=true}}</td>
          </tr>
          <tr>
             <th>{{mb_label object=$echange_soap field="_date_max"}}</th>
             <td>{{mb_field object=$echange_soap field="_date_max" form="filterEchange" register=true}}</td>
          </tr>
          <tr>
