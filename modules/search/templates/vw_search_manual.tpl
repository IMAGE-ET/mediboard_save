...
<form method="get" name="esSearch" action="?m=search&tab=vw_search_auto" class="watched prepared" onsubmit="return Search.displayResults(this);" onchange="onchange=$V(this.form, '0')">
