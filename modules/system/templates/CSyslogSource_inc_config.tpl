  ...
  <tr>
    <td>
      <form name="editSyslogSource-{{$source->name}}" method="post"
        ...
        <fieldset>
          <legend>{{tr}}CSyslogSource{{/tr}}</legend>
          ...
          <table class="form">
            ...
            <tr>
              ...
              {{assign var=placeholder value='CAppUI::tr'|static_call:"common-msg-No password"}}
              {{if $source->password}}
                {{assign var=placeholder value='CAppUI::tr'|static_call:"common-msg-Password saved"}}
              {{/if}}
            ...
            <tr>
              ...
              {{assign var=placeholder value='CAppUI::tr'|static_call:"common-msg-No passphrase"}}
              {{if $source->ssl_passphrase}}
                {{assign var=placeholder value='CAppUI::tr'|static_call:"common-msg-Passphrase saved"}}
              {{/if}}
