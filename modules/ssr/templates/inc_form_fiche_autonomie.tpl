<form name="editFicheAutonomie" action="?m={{$m}}" method="post" onsubmit="return checkForm(this)">
  ...
  <table class="form">
    <tr>
      <th class="category" rowspan="13" style="width:0.1%">{{tr}}CFicheAutonomie-autonomie-perso{{/tr}}</th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="4">{{mb_field object=$fiche_autonomie field="soins_cutanes"}}</td>
    </tr>
    <tr>
      <td colspan="6"></td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="5">{{mb_field object=$fiche_autonomie field="etat_psychique"}}</td>
    </tr>
    <tr>
      <td colspan="6"></td>
    </tr>
