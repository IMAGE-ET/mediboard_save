...
{{if $praticien->_ref_deplacees|@count}}
  ...
  <table class="tbl">
    {{mb_include module="salleOp" template="inc_liste_operations" urgence=1 operations=$praticien->_ref_deplacees}}
  </table>
{{/if}}
...
{{if $praticien->_ref_urgences|@count}}
  ...
  <table class="tbl">
    {{mb_include module="salleOp" template="inc_liste_operations" urgence=1 operations=$praticien->_ref_urgences}}
  </table>
{{/if}}