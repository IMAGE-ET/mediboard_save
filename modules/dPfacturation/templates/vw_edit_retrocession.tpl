...
Main.add(function () {
  ...
  {{elseif "tarmed"|module_active && $conf.tarmed.CCodeTarmed.use_cotation_tarmed}}
  ...
  <tr>
    ...
    <td>
      <select name="praticien_id" onchange="this.form.submit();">
        {{mb_include module=mediusers template=inc_options_mediuser list=$listPrat selected=$retrocession->praticien_id}}
      </select>
    </td>
  </tr>
  <tr>
