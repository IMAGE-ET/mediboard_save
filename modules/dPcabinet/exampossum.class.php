...
class CExamPossum extends CMbObject {
  ...
  function getSpecs() {
    return array (
      ...
      "signes_respiratoires" => "enum|aucun|dyspnee_effort|bpco_leger|dyspnee_inval|bpco_modere|dyspnee_repos|fibrose",
      "uree"                 => "enum|inf7.5|7.6|10.1|sup15.1",
      "freq_cardiaque"       => "enum|inf39|40|50|81|101|sup121",
      "signes_cardiaques"    => "enum|aucun|diuretique|antiangineux|oedemes|cardio_modere|turgescence|cardio",
      "hb"                   => "enum|inf9.9|10|11.5|13|16.1|17.1|sup18.1",
      "leucocytes"           => "enum|inf3000|3100|4000|10100|sup20100",
      "ecg"                  => "enum|normal|fa|autre|sup5|anomalie",
      "kaliemie"             => "enum|inf2.8|2.9|3.2|3.5|5.1|5.4|sup6.0",
      "natremie"             => "enum|inf125|126|131|sup136",
      "pression_arterielle"  => "enum|inf89|90|100|110|131|sup171",
      "gravite"              => "enum|min|moy|maj|maj+",
      "nb_interv"            => "enum|1|2|sup2",
      "pertes_sanguines"     => "enum|inf100|101|501|sup1000",
      "contam_peritoneale"   => "enum|aucune|mineure|purulente|diffusion",
      "cancer"               => "enum|absense|tumeur|ganglion|metastases",
      "circonstances_interv" => "enum|reglee|urg|prgm|sansdelai"
    );
  }
