<form name="editScoreApfel" method="post" action="?" onsubmit="return onSubmitFormAjax(this);">
  ...
  <label title="Calculé en cliquant sur Evaluer">
    <input type="checkbox" onchange="$V(this.form.apfel_femme, this.checked ? 1 : 0); this.form.onsubmit();"
  ...
  <label title="Calculé en cliquant sur Evaluer (codes cim10 détectés : F17 / T652 / Z720 / Z864 / Z587">
    <input type="checkbox" onchange="$V(this.form.apfel_non_fumeur, this.checked ? 1 : 0); this.form.onsubmit();"
  ...
  <label title="Non calculé">
    <input type="checkbox" onchange="$V(this.form.apfel_atcd_nvp, this.checked ? 1 : 0); this.form.onsubmit();"
  ...
  <label title="Non calculé">
    <input type="checkbox" onchange="$V(this.form.apfel_morphine, this.checked ? 1 : 0); this.form.onsubmit();"
