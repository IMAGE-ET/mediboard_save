	...
	*/
	class TCPDF {
		...
		*/
		 ...
		 * @since 1.53.0.TC017
		 */
		protected $prevFillColor = array(255,255,255);
		 ...
		 * @since 1.53.0.TC017
		 */
		protected $prevTextColor = array(0,0,0);
      ...
      require_once(dirname(__FILE__)."/barcode/c128bobject.php");
			require_once(dirname(__FILE__)."/barcode/cmb128bobject.php");
			...
			switch (strtoupper($type)) {
				...
				default:
				case "C128B": {
					$obj = new CMB128BObject($bc_w, $bc_h, $style, $code);
					break;
				}
				case "C128C": {
