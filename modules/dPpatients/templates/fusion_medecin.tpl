...
<table class="form">
  ...
  <tr>
    ...
    <td>
      <input type="radio" name="_choix_nom" value="{{$medecin2->nom}}" onclick="setField(this.form.nom, '{{$medecin2->nom|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin2->nom}}
    </td>
    <td>
  ...
  <tr>
    ...
    <td>
      <input type="radio" name="_choix_prenom" value="{{$medecin1->prenom}}" checked="checked" onclick="setField(this.form.prenom, '{{$medecin1->prenom|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin1->prenom}}
    </td>
    <td>
      <input type="radio" name="_choix_prenom" value="{{$medecin2->prenom}}" onclick="setField(this.form.prenom, '{{$medecin2->prenom|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin2->prenom}}
    </td>
    <td>
  ...
  <tr>
    ...
    <td>
      <input type="radio" name="_choix_adresse" value="{{$medecin1->adresse}}" checked="checked" onclick="setField(this.form.adresse, '{{$medecin1->adresse|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin1->adresse}}
    </td>
    <td>
      <input type="radio" name="_choix_adresse" value="{{$medecin2->adresse}}" onclick="setField(this.form.adresse, '{{$medecin2->adresse|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin2->adresse}}
    </td>
    <td>
  ...
  <tr>
    ...
    <td>
      <input type="radio" name="_choix_cp" value="{{$medecin1->cp}}" checked="checked" onclick="setField(this.form.cp, '{{$medecin1->cp|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin1->cp}}
    </td>
    <td>
      <input type="radio" name="_choix_cp" value="{{$medecin2->cp}}" onclick="setField(this.form.cp, '{{$medecin2->cp|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin2->cp}}
    </td>
    <td>
  ...
  <tr>
    ...
    <td>
      <input type="radio" name="_choix_ville" value="{{$medecin1->ville}}" checked="checked" onclick="setField(this.form.ville, '{{$medecin1->ville|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin1->ville}}
    </td>
    <td>
      <input type="radio" name="_choix_ville" value="{{$medecin2->ville}}" onclick="setField(this.form.ville, '{{$medecin2->ville|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin2->ville}}
    </td>
    <td>
  ...
  <tr>
    ...
    <td class="text">
      <input type="radio" name="_choix_disciplines" value="{{$medecin1->disciplines}}" checked="checked" onclick="setField(this.form.disciplines, '{{$medecin1->disciplines|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin1->disciplines|nl2br}}
    </td>
    <td class="text">
      <input type="radio" name="_choix_disciplines" value="{{$medecin2->disciplines}}" onclick="setField(this.form.disciplines, '{{$medecin2->disciplines|smarty:nodefaults|JSAttribute}}')" />
  ...
  <tr>
    ...
    <td class="text">
      <input type="radio" name="_choix_orientations" value="{{$medecin1->orientations}}" checked="checked" onclick="setField(this.form.orientations, '{{$medecin1->orientations|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin1->orientations|nl2br}}
    </td>
    <td class="text">
      <input type="radio" name="_choix_orientations" value="{{$medecin2->orientations}}" onclick="setField(this.form.orientations, '{{$medecin2->orientations|smarty:nodefaults|JSAttribute}}')" />
  ...
  <tr>
    ...
    <td class="text">
      <input type="radio" name="_choix_complementaires" value="{{$medecin1->complementaires}}" checked="checked" onclick="setField(this.form.complementaires, '{{$medecin1->complementaires|smarty:nodefaults|JSAttribute}}')" />
      {{$medecin1->complementaires|nl2br}}
    </td>
    <td class="text">
      <input type="radio" name="_choix_complementaires" value="{{$medecin2->complementaires}}" onclick="setField(this.form.complementaires, '{{$medecin2->complementaires|smarty:nodefaults|JSAttribute}}')" />
