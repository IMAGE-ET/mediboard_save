...
$dest_hprim->destinataire = $message_hprim->destinataire;
...
if ($message_hprim->initiateur_id) {
	...
	if (null == $acquittement = $client->notificationEvenementPatient($messageEvtPatient)) {
...
$message_hprim->acquittement = $acquittement;
$message_hprim->store();
