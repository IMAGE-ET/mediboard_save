...
{{if $_field == "_view"}}
  <span class="draggable hostfield value" data-field="{{$_field}}" data-type="value" data-ex_group_id="{{$ex_group_id}}" {{if $_host_field}}data-field_id="{{$_host_field->_id}}"{{/if}}>
...
{{else}}
  {{if !$_type || $_type == "label"}}
	  <span class="draggable hostfield label" data-field="{{$_field}}" data-type="label" data-ex_group_id="{{$ex_group_id}}" {{if $_host_field}}data-field_id="{{$_host_field->_id}}"{{/if}}>
