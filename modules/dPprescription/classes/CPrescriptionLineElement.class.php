  ...
  function updateFormFields(){
    ...
    if($this->fin){
        ...
        if ($this->duree && $this->unite_duree){
          $this->_duree_prise .= " pendant ".$this->duree." ".CAppUI::tr("CPrescriptionLineElement.unite_duree.".$this->unite_duree);
        }
	    }
    }
		
		if($this->duree && $this->unite_duree == "jour" && CAppUI::conf("dPprescription CPrescription duration_in_hours") && !$this->time_fin){
      $duree = $this->duree * 24;
