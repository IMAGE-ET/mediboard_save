...
$locales['query-pace-0'] = 'Requête SQL ultra rapide sur DSN \'%s\' : %sms sur %sms';
$locales['query-pace-1'] = 'Requête SQL très rapide sur DSN \'%s\' : %sms sur %sms';
$locales['query-pace-2'] = 'Requête SQL rapide sur DSN \'%s\' : %sms sur %sms';
$locales['query-pace-3'] = 'Requête SQL moyenne sur DSN \'%s\' : %sms sur %sms';
$locales['query-pace-4'] = 'Requête SQL lente sur DSN \'%s\' : %sms sur %sms';
$locales['query-pace-5'] = 'Requête SQL très lente sur DSN \'%s\' : %sms sur %sms';
$locales['query-pace-6'] = 'Requête SQL ultra lente sur DSN \'%s\' : %sms sur %sms';
$locales['reload'] = 'Recharger';
