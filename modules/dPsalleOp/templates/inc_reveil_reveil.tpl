        ...
        <tr>
          ...
          <td class="button">
            <form name="editSortieBlocFrm{$curr_op->operation_id}" action="index.php?m={$m}" method="post">
              ...
              {/if}
              <button class="cancel" type="submit" onclick="this.form.entree_reveil.value = ''"></button>
            </form>
          </td>
          <td class="button">
            <form name="editEntreeReveilFrm{$curr_op->operation_id}" action="index.php?m={$m}" method="post">
              ...
              <button class="tick" type="submit" onclick="this.form.sortie_reveil.value = 'current'"></button>
            </form>
          </td>
        </tr>
        {/foreach}
