        ...
        <tr>
          ...
          <td class="text" width="200">
            ...
            <table class="text">
              ...
              <input type="radio" name="position" onClick="submitFormAjax(this.form, 'systemMsg')" value="{{$consult_anesth->_enums.position[rows]}}" {{if $consult_anesth->position == $consult_anesth->_enums.position[rows]}}checked="checked"{{/if}} /><label for="position_{{$consult_anesth->_enums.position[rows]}}" title="{{tr}}{{$consult_anesth->_enums.position[rows]}}{{/tr}}">{{tr}}{{$consult_anesth->_enums.position[rows]}}{{/tr}}</label>
