<div style="display:none;">
  <table class="form" id="glasgow_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> 14-15</td>
    </tr>
  </table>
  <table class="form" id="pupilles_tooltip">
    ...
    <tr>
      <td><strong>Degré 2:</strong> Anormales</td>
    </tr>
    <tr>
      <td><strong>Degré 3:</strong> Normales</td>
    </tr>
  </table>
  <table class="form" id="pouls_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> 51-129</td>
    </tr>
  </table>
  ...
  <table class="form" id="frequence_respiratoire_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> 13-24</td>
    </tr>
  </table>
  <table class="form" id="spo2_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> 94-100</td>
    </tr>
  </table>
  <table class="form" id="peak_flow_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> > 50%</td>
    </tr>
  </table>
  <table class="form" id="temperature_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> 35,1-40</td>
    </tr>
  </table>
  <table class="form" id="glycemie_tooltip">
    <tr>
      <th class="category" style="text-align: center">Glycémie</th>
    </tr>
    <tr>
      <td><strong>Degré 2:</strong> < 4 ou &ge; 25 </td>
    </tr>
    <tr>
      <td><strong>Degré 3:</strong> 4-24,9</td>
    </tr>
  </table>
  <table class="form" id="cetonemie_tooltip">
    <tr>
      <th class="category" style="text-align: center">Cétonémie</th>
    </tr>
    <tr>
      <td><strong>Degré 2:</strong> &ge; 0,6 </td>
    </tr>
    <tr>
      <td><strong>Degré 3:</strong> < 0,6</td>
    </tr>
  </table>
  <table class="form" id="proteinurie_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> Négative</td>
    </tr>
  </table>
  <table class="form" id="contraction_uterine_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> < 1/10mn</td>
    </tr>
  </table>
  <table class="form" id="bruit_foetal_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> 120-159</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><strong>Degré 3:</strong> Présent</td>
    </tr>
  </table>
  <table class="form" id="liquide_amniotique_tooltip">
    ...
    <tr>
      <td><strong>Degré 3:</strong> Teinté/clair/rosé</td>
    </tr>
  </table>
  ...
  <table class="form" id="idx_choc" style="display:none;">
    ...
    <tr>
      <td><strong>Degré 3:</strong> Pouls &le; TAS</td>
    </tr>
  </table>
</div>