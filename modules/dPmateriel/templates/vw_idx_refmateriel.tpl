      ...
      <table class="form">
        ...
        <tr>
          <td class="button" colspan="2">
            ...
            {if $reference->reference_id}
              <button class="trash" type="button" onclick="confirmDeletion(this.form,{ldelim}typeName:'la référence',objName:'{$reference->_view|escape:javascript}'{rdelim})">Supprimer</button>
            {/if}
          </td>
        </tr>        
      </table>
