<table class="tbl" style="width: auto !important;">
  ...
  <tr>
    ...
    <td class="text">
      % du nombre de lits occupés (p/r au nombre de lits ouverts) de manière prévisionnelle à minuit.<br />
  ...
  <tr>
    ...
    <td class="text">
      % du nombre de lits réellement occupés (p/r au nombre de lits ouverts),<br />
  ...
  <tr>
    ...
    <td>
      % du nombre d'entrée dans le journée (p/r au nombre de lits ouverts). <br />
