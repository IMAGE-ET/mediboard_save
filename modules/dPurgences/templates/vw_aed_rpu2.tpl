    ...
    <td style="width:60%;">
      ...
      <div style="float:left;width:50%;">
        <form name="editBox" action="?m={{$m}}{{if !$can->edit}}&amp;tab=vw_idx_rpu{{/if}}" method="post" onsubmit="return checkForm(this)">
          ...
          <table class="form">
            <tr>
              <th class="category" colspan="2">Compléments</th>
            </tr>
            <tr>
              <th>{{mb_label object=$rpu field="diag_infirmier"}}</th> 
              <td>
                {{mb_field object=$rpu field="diag_infirmier" class="autocomplete" form="editBox"
                              aidesaisie="validate: function() { form.onsubmit() },
                                          validateOnBlur: 0,
                                          resetSearchField: 0,
                                          resetDependFields: 0"}}
            ...
            <tr>
              ...
              <td>{{mb_field object=$rpu field="code_diag" style="width: 15em;"}}</td>
            </tr>
            {{if $can->edit}}
              <tr>
            ...
            <tr>
              <td class="button" colspan="2">
                <button class="submit" onclick="this.form.submit();">Enregistrer</button>
              </td>
            </tr>
          </table>
        </form>
