<table class="form">
  ...
  <tr>
    ...
    <td colspan="2">
      <input tabindex="255" type="text" size="17" maxlength="15" name="matricule" title="{{$patient->_props.matricule}}" value="{{$patient->matricule}}" />
    </td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="2">
      <input onblur="oAccord.changeTabAndFocus(2, this.form.prevenir_nom);" tabindex="256" type="text" size="8" maxlength="8" name="SHS" title="{{$patient->_props.SHS}}" value="{{$patient->SHS}}" />
    </td>
  </tr>
