...
<table class="tbl">
  ...
  {{if $consultation->_ref_categorie->_id}}
    <tr>
      <td colspan="2">
        Catégorie : 
        {{mb_include module=cabinet template=inc_icone_categorie_consult categorie=$consultation->_ref_categorie display_name=true}}
      </td>
    </tr>
  {{/if}}
