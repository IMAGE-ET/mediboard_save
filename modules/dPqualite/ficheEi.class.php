...
class CFicheEi extends CMbObject {
  ...
  function getSpecs() {
    return array (
      ...
      "type_incident"                => "notNull enum|inc|ris",
      "elem_concerne"                => "notNull enum|pat|vis|pers|med|mat",
      "elem_concerne_detail"         => "notNull text",
      "autre"                        => "text",
      "descr_faits"                  => "notNull text",
      "mesures"                      => "notNull text",
      "descr_consequences"           => "notNull text",
      "gravite"                      => "notNull enum|nul|mod|imp",
      "suite_even"                   => "notNull enum|trans|plong|deces|autre",
      "suite_even_descr"             => "text",
      "plainte"                      => "notNull enum|non|oui",
      "commission"                   => "notNull enum|non|oui",
