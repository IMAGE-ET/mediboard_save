  ...
  <table class="form">
    ...
    <tr>
      <td colspan="2">
         <div class="small-info">
          <span>{{tr}}config-dPfiles-upload_max_filesize{{/tr}} : <strong>{{$conf.dPfiles.upload_max_filesize}}</strong></span>
        </div>
      </td>
    </tr>
    <tr id="fileRow">
    ...
    <tr>
      <td colspan="2" class="button">
        <button type="submit" class="add" title="{{tr}}Add{{/tr}}" onclick="showLoading();">
          {{tr}}Add{{/tr}}
        </button>
      </td>
    </tr>
